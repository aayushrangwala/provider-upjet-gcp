...
type CloudFunctionInitParameters struct {
	...
	// Example value: "func1".
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/cluster/cloudfunctions/v1beta2.Function
...
type CloudRunInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/cluster/cloudrun/v1beta2.Service
	Service *string `json:"service,omitempty" tf:"service,omitempty"`

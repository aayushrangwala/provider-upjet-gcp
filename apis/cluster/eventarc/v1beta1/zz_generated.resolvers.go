...
func (mg *Trigger) ResolveReferences( // ResolveReferences of this Trigger.
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.Transport); i3++ {
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Transport[i3].Pubsub); i4++ {
			{
			...
			if err != nil {
				return errors.Wrap(err, "mg.Spec.ForProvider.Transport[i3].Pubsub[i4].Topic")
			}
			mg.Spec.ForProvider.Transport[i3].Pubsub[i4].Topic = reference.ToPtrValue(rsp.ResolvedValue)
			mg.Spec.ForProvider.Transport[i3].Pubsub[i4].TopicRef = rsp.ResolvedReference
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.Transport); i3++ {
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Transport[i3].Pubsub); i4++ {
			{
				m, l, err = apisresolver.GetManagedResource("pubsub.gcp.upbound.io", "v1beta2", "Topic", "TopicList")
				if err != nil {
					return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			...
			if err != nil {
				return errors.Wrap(err, "mg.Spec.InitProvider.Transport[i3].Pubsub[i4].Topic")
			}
			mg.Spec.InitProvider.Transport[i3].Pubsub[i4].Topic = reference.ToPtrValue(rsp.ResolvedValue)
			mg.Spec.InitProvider.Transport[i3].Pubsub[i4].TopicRef = rsp.ResolvedReference

...
type PageInitParameters struct {
	...
	// Format: projects//locations//agents//flows/.
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/cluster/dialogflowcx/v1beta2.Agent
...
type PageKnowledgeConnectorSettingsInitParameters struct {
	...
	// This field is part of a union field target: Only one of targetPage or targetFlow may be set.
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/cluster/dialogflowcx/v1beta2.Page
...
type PageKnowledgeConnectorSettingsTriggerFulfillmentInitParameters struct {
	...
	// The webhook to call. Format: projects//locations//agents//webhooks/.
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/cluster/dialogflowcx/v1beta2.Webhook
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	Webhook *string `json:"webhook,omitempty" tf:"webhook,omitempty"`

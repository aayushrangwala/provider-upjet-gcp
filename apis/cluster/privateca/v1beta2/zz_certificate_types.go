...
type CertificateInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/cluster/privateca/v1beta2.CertificateAuthority
	...
	// as the Certificate.
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/cluster/privateca/v1beta2.CertificateTemplate

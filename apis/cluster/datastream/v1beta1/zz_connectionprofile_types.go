...
type PostgresqlProfileInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/cluster/sql/v1beta1.DatabaseInstance
...
type PostgresqlProfileParameters struct {
	...
	// Username for the PostgreSQL connection.
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/cluster/sql/v1beta1.User
	// +kubebuilder:validation:Optional
	Username *string `json:"username,omitempty" tf:"username,omitempty"`
...
type PrivateConnectivityInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/cluster/datastream/v1beta1.PrivateConnection

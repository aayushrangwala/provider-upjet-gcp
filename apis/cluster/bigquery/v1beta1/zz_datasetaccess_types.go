...
type DatasetAccessDatasetDatasetInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/cluster/bigquery/v1beta1.Dataset
...
type DatasetAccessRoutineInitParameters struct {
	...
	// The ID of the dataset containing this table.
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/cluster/bigquery/v1beta1.Routine
...
type DatasetAccessViewInitParameters struct {
	...
	// A-Z), numbers (0-9), or underscores (_). The maximum length
	// is 1,024 characters.
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/cluster/bigquery/v1beta1.Table

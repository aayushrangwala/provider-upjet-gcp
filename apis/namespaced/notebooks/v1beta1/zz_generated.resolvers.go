...
func (mg *InstanceIAMMember) ResolveReferences( // ResolveReferences of this InstanceIAMMember.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("notebooks.gcp.m.upbound.io", "v1beta1", "Instance", "InstanceList")
		if err != nil {
...
func (mg *RuntimeIAMMember) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("notebooks.gcp.m.upbound.io", "v1beta1", "Runtime", "RuntimeList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}

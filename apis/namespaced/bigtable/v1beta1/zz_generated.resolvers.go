...
func (mg *AppProfile) ResolveReferences( // ResolveReferences of this AppProfile.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("bigtable.gcp.m.upbound.io", "v1beta1", "Instance", "InstanceList")
		if err != nil {
...
func (mg *GarbageCollectionPolicy) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	{
		m, l, err = apisresolver.GetManagedResource("bigtable.gcp.m.upbound.io", "v1beta1", "Table", "TableList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}

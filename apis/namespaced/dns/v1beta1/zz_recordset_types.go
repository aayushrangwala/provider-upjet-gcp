...
type PrimaryInternalLoadBalancersInitParameters struct {
	...
	// The frontend IP address of the load balancer.
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/namespaced/compute/v1beta1.ForwardingRule
...
type RecordSetInitParameters struct {
	...
	// reside.
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/namespaced/dns/v1beta1.ManagedZone

...
import (
	...
	common "github.com/aayushrangwala/provider-upjet-gcp/v2/config/namespaced/common"
...
func (mg *Certificate) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("privateca.gcp.m.upbound.io", "v1beta1", "CertificateAuthority", "CertificateAuthorityList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("privateca.gcp.m.upbound.io", "v1beta1", "CertificateTemplate", "CertificateTemplateList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}

...
type CloudFunctionInitParameters struct {
	...
	// Example value: "func1".
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/namespaced/cloudfunctions/v1beta1.Function
...
type CloudRunInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/namespaced/cloudrun/v1beta1.Service
	Service *string `json:"service,omitempty" tf:"service,omitempty"`
...
type RegionNetworkEndpointGroupInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/aayushrangwala/provider-upjet-gcp/v2/apis/namespaced/compute/v1beta1.ServiceAttachment

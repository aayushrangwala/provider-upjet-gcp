...
func (mg *AccessLevelCondition) ResolveReferences( // ResolveReferences of this AccessLevelCondition.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("accesscontextmanager.gcp.m.upbound.io", "v1beta1", "AccessLevel", "AccessLevelList")
		if err != nil {
...
func (mg *ServicePerimeterResource) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("accesscontextmanager.gcp.m.upbound.io", "v1beta1", "ServicePerimeter", "ServicePerimeterList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}

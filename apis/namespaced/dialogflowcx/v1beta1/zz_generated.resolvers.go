...
func (mg *Environment) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.VersionConfigs); i3++ {
		{
			m, l, err = apisresolver.GetManagedResource("dialogflowcx.gcp.m.upbound.io", "v1beta1", "Version", "VersionList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			}
			rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
...
func (mg *Flow) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	if mg.Spec.ForProvider.KnowledgeConnectorSettings != nil {
		if mg.Spec.ForProvider.KnowledgeConnectorSettings.TriggerFulfillment != nil {
			{
				m, l, err = apisresolver.GetManagedResource("dialogflowcx.gcp.m.upbound.io", "v1beta1", "Webhook", "WebhookList")
				if err != nil {
					return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
				}
				rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
	...
	if mg.Spec.ForProvider.Form != nil {
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Form.Parameters); i4++ {
			if mg.Spec.ForProvider.Form.Parameters[i4].FillBehavior != nil {
				for i6 := 0; i6 < len(mg.Spec.ForProvider.Form.Parameters[i4].FillBehavior.RepromptEventHandlers); i6++ {
					{
						m, l, err = apisresolver.GetManagedResource("dialogflowcx.gcp.m.upbound.io", "v1beta1", "Page", "PageList")
						if err != nil {
							return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
						}
						rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{

...
func (mg *AppConnection) ResolveReferences( // ResolveReferences of this AppConnection.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("beyondcorp.gcp.m.upbound.io", "v1beta1", "AppConnector", "AppConnectorList")
		if err != nil {
	...
	if mg.Spec.ForProvider.Gateway != nil {
		{
			m, l, err = apisresolver.GetManagedResource("beyondcorp.gcp.m.upbound.io", "v1beta1", "AppGateway", "AppGatewayList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			}

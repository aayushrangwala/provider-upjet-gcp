...
import (
	...
	"github.com/aayushrangwala/provider-upjet-gcp/v2/config/namespaced/common"
)

const (
	// SelfPackagePath is the golang path for this package.
	SelfPackagePath = "github.com/aayushrangwala/provider-upjet-gcp/v2/config/namespaced/compute"
)
...
func Configure(p *config.Provider) { // nolint: gocyclo
	...
	p.AddResourceConfigurator("google_compute_instance_group_named_port", func(r *config.Resource) {
		...
		// 	Type:      "github.com/aayushrangwala/provider-upjet-gcp/v2/apis/namespaced/container/v1beta1.Cluster",

...
const (
	...
	SelfPackagePath = "github.com/aayushrangwala/provider-upjet-gcp/v2/config/cluster/common"

	// ExtractResourceIDFuncPath holds the GCP resource ID extractor func name
	ExtractResourceIDFuncPath = "github.com/aayushrangwala/provider-upjet-gcp/v2/config/cluster/common.ExtractResourceID()"
	ExtractProjectIDFuncPath  = "github.com/aayushrangwala/provider-upjet-gcp/v2/config/cluster/common.ExtractProjectID()"
	ExtractFolderIDFuncPath   = "github.com/aayushrangwala/provider-upjet-gcp/v2/config/cluster/common.ExtractFolderID()"

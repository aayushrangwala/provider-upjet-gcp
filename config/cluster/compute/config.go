...
import (
	...
	"github.com/aayushrangwala/provider-upjet-gcp/v2/config/cluster/common"
)

const (
	// SelfPackagePath is the golang path for this package.
	SelfPackagePath = "github.com/aayushrangwala/provider-upjet-gcp/v2/config/cluster/compute"
)
...
func Configure(p *config.Provider) { // nolint: gocyclo
	...
	p.AddResourceConfigurator("google_compute_instance_group_named_port", func(r *config.Resource) {
		...
		// 	Type:      "github.com/aayushrangwala/provider-upjet-gcp/v2/apis/cluster/container/v1beta1.Cluster",

...
//go:generate go run github.com/crossplane/upjet/v2/cmd/resolver -g gcp.upbound.io -a github.com/aayushrangwala/provider-upjet-gcp/v2/internal/apis -s -p ../apis/cluster/...
//go:generate go run github.com/crossplane/upjet/v2/cmd/resolver -g gcp.m.upbound.io -a github.com/aayushrangwala/provider-upjet-gcp/v2/internal/apis -s -p ../apis/namespaced/...
